...
chunkfile<-"06_Genetic_CoAncestry/Duttoniana_min_max_1pop_Multi.haps_chunks.out" ## RADpainter output file
mcmcfile<-"06_Genetic_CoAncestry/Duttoniana_min_max_1pop_Multi.haps_chunks.mcmc.xml" ## finestructure mcmc file
treefile<-"06_Genetic_CoAncestry/Duttoniana_min_max_1pop_Multi.haps_chunks.mcmcTree.xml" ## finestructure tree file
...
analysisName <- "Duttoniana_Genetic_CoAncestry";  maxIndv <- 1000; maxPop<-1000
